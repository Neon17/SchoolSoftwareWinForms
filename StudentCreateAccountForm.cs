...
{
    public partial class StudentCreateAccountForm : Form
    {
        public StudentCreateAccountForm()
        {
            InitializeComponent();
        }

        private void StudentCreateAccountForm_Load(object sender, EventArgs e)
        {
        ...
        private bool InsertToDatabase ()
        {
            ...
            conn.Open();
            SqlCommand query = new SqlCommand("Insert into STable (Id, Name, Password) VALUES (@Id, @Name, @Password)", conn);
            try {
